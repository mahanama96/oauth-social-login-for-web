            ...
            <div class="card">
              ...
              <div class="card-body">
                    ...
                    <div class="row" align="center">
                      ...
                      <div class="col-sm-1">
                          <a href="https://graph.facebook.com/oauth/authorize?response_type= token&client_id=209518916300016&redirect_uri=https://localhost/oauth-social-login-for-web/user-profile.php&scope=email%20public_profile" class="btn btn-primary" style="border-radius: 50%;color: white;width: 70px;height: 70px;font-size: 40px">f
                                </a>
                      </div>
